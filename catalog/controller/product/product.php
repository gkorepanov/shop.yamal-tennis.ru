...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if ($product_info) {
			...
			$this->data['text_additional_pictures'] = $this->language->get('text_additional_pictures');
      ...
      $this->data['button_cart'] = $this->language->get('button_cart');
			...
			$this->data['text_instock'] = sprintf($this->language->get('text_in_stock'), (string)$this->data['stock']);
			$this->data['text_nostock'] = $this->language->get('text_out_of_stock');
			...
			$this->data['mimage'] = $this->model_tool_image->resize($product_info['mimage'], 150, 40);
