<?php
// Text
$_['text_new_subject']          = '%s - напоминание о заказе %s';
$_['text_new_greeting']         = 'Благодарим за интерес к товарам %s.';
$_['text_new_link_abandoned']   = 'Вы оформляли заказ, но по неизвестной нам причине не оформили его до конца. Если Вы подтверждаете свой заказ, то сообщите нам. Для просмотра Вашего заказа перейдите по ссылке:';
$_['text_new_link_deffered']    = 'Ваш заказ проверен и ожидает оплаты. Для просмотра Вашего заказа и оплаты перейдите по ссылке:';
