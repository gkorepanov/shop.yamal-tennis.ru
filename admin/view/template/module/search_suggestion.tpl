        ...
        <table id="where" class="list">
          ...
          <tbody >
            ...
            <tr>
              ...
              <td class="left">
                <input type="text" name="search_suggestion_options[relevance][model_word_weight]" value="<?php echo isset($options['relevance']['model_word_weight']) ? $options['relevance']['model_word_weight'] : 30;?>">
              </td>              
            </tr>
            <tr>
              <td width="1" style="text-align: center;">
              ...
              <td class="left">
                <input type="text" name="search_suggestion_options[relevance][sku_word_weight]" value="<?php echo isset($options['relevance']['sku_word_weight']) ? $options['relevance']['sku_word_weight'] : 30;?>">
              </td>              
            </tr>
